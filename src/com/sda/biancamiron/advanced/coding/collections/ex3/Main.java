package com.sda.biancamiron.advanced.coding.collections.ex3;
...
public class Main {
    ...
    public static void printMapContentV2(Map<String, Integer> inputMapContent) {
        Set<Map.Entry<String, Integer>> entries = inputMapContent.entrySet();
        List<Map.Entry<String, Integer>> entriesAsList = new ArrayList<>(entries);    //convertire de la set la lista
