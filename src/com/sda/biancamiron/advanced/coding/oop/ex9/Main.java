...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(listOfInteger.getEveryNthElement(10,3));
        System.out.println(listOfInteger.getEveryNthElement(-1,3));
        System.out.println(listOfInteger.getEveryNthElement(2,-1));
    }
}
